...
__webpack_require__(/*! ./bootstrap */ "./resources/js/bootstrap.js"); // TODO: dividere javascript public e admin
...
window.addEvent = function (elem) {
  var inputs_old = elem.querySelectorAll("input");
  ...
  var clone = date_time_template.content.firstElementChild.cloneNode(true);
...
window.addInfo = function (elem) {
  var tag = elem.querySelector("input");
  ...
  var clone = info_template.content.firstElementChild.cloneNode(true);
...
window.removeInfo = function (elem) {
  var key = elem.querySelector('label');
...
window.imagePreview = function (poster, id_preview) {
  ...
  var _poster$files = _slicedToArray(poster.files, 1),
      file = _poster$files[0];
